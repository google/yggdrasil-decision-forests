...
absl::Status PlotBinaryCalibrationCurves(
  ...
  reliability_curve->xs.reserve(
      binary_calibration_data.reliability_diagram_count_size());
  reliability_curve->ys.reserve(
      binary_calibration_data.reliability_diagram_count_size());
  reliability_curve->point_labels.reserve(
      binary_calibration_data.reliability_diagram_count_size());
  reliability_curve->error_ys.reserve(
      binary_calibration_data.reliability_diagram_count_size());
  reliability_curve->minus_error_ys.reserve(
      binary_calibration_data.reliability_diagram_count_size());
