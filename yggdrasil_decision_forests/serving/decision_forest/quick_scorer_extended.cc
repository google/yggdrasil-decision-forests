...
template <typename Model, float (*Activation)(float)>
ABSL_ATTRIBUTE_ALWAYS_INLINE void PredictQuickScorerMajorFeatureOffsetHighway(
    const Model& model,
    const std::vector<NumericalOrCategoricalValue>& fixed_length_features,
    const std::vector<Rangei32>& categorical_set_begins_and_ends,
...
PredictQuickScorerMajorFeatureOffsetHighwayIdentity(
    const Model& model,
    const std::vector<NumericalOrCategoricalValue>& fixed_length_features,
    const std::vector<Rangei32>& categorical_set_begins_and_ends,
    const std::vector<int32_t>& categorical_item_buffer, const int num_examples,
...
template <typename Model>
ABSL_ATTRIBUTE_ALWAYS_INLINE void
PredictQuickScorerMajorFeatureOffsetHighwayLogLikelihood(
    const Model& model,
    const std::vector<NumericalOrCategoricalValue>& fixed_length_features,
    const std::vector<Rangei32>& categorical_set_begins_and_ends,
    const std::vector<int32_t>& categorical_item_buffer, const int num_examples,
...
template <typename Model>
ABSL_ATTRIBUTE_ALWAYS_INLINE void
PredictQuickScorerMajorFeatureOffsetHighwayPoisson(
    const Model& model,
    const std::vector<NumericalOrCategoricalValue>& fixed_length_features,
    const std::vector<Rangei32>& categorical_set_begins_and_ends,
    const std::vector<int32_t>& categorical_item_buffer, const int num_examples,
